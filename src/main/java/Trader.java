...
public class Trader<T> {
     ...
     */
    public void addToWishlist(T someObject){
        wishlist.add(someObject);
    }
     ...
     */
    public int getSellingPrice(T someObject){
        if(someObject instanceof Tradable){
            return ((Tradable) someObject).getPrice();
        }
        return Tradable.MISSING_PRICE;
    }
